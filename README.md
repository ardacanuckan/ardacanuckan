...
<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=6C63FF&center=true&vCenter=true&multiline=true&repeat=false&width=700&height=160&lines=class+Arda%3A;++++current_role+%3D+%22Tech+Lead+%40Acta%22;++++current_project+%3D+%22AgentOS%22;++++mission+%3D+%22Building+agent+orchestration%22;++++stack+%3D+%5B%22Go%22%2C+%22TypeScript%22%2C+%22Python%22%5D" alt="Typing SVG" /></a>
...
class Arda:
    def __init__(self):
        ...
        self.current_project = "AgentOS — Agent orchestration for an autonomous era"
...
| 🤖 **AgentOS** | Building enterprise-grade agent orchestration infrastructure @Acta |
...
> Production-grade agent orchestration infrastructure built with Go
