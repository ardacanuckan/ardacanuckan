...
<details>
<summary><b>🤖 AgentOS & AgentVM</b> — agent orchestration for an autonomous era</summary>
<br>

- **AgentOS** — Full-stack agent orchestration platform for managing autonomous AI workflows at scale
- **AgentVM** — Low-abstraction VM-orchestrator in Go providing paginated, clean runner abstraction for parallel agentic workflows
- Built with Go, gRPC, Docker containerization for isolated agent execution
- Features real-time log streaming, multi-tool support (Claude, Gemini, Goose), and cloud deployment on GCP
